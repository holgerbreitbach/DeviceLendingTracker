        ...
        <div class="flex justify-between items-center mb-1">
            <div class="flex-grow h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Suche in {{ $this->searchableColumns()->map->label->join(', ') }}" />
            ...
            <div class="flex items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <button wire:click="export" class="flex items-center space-x-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none"><span>Exportieren</span>
                ...
                <div class="p-2 sm:flex items-center justify-between">
                    ...
                    @if($this->results[1])
                        ...
                        <div class="flex justify-end text-gray-600">
                            Ergebnis {{ $this->results->firstItem() }} - {{ $this->results->lastItem() }} von
                            {{ $this->results->total() }}
                        </div>
                    @endif
                </div>
