...
class LendingTables extends LivewireDatatable
{
    ...
    public function builder()
    {
        return Lending::query()
            ...
            ->leftJoin('orgs', 'lendings.org_id_1', 'orgs.id')->whereNull('lendings.org_id_2');
    }
    ...
    public function columns()
    {
        return [
            ...
            Column::name('teacher.name')->truncate()->searchable()->label('Name'),
            Column::name('teacher.forename')->truncate()->searchable()->label('Vorname'),
            Column::name('teacher.code')->truncate()->searchable()->label('PLZ'),
            Column::name('teacher.location')->truncate()->searchable()->label('Ort'),
            Column::name('orgs.name')->truncate()->searchable()->label('Ausgeliehen von (MZ)'),
            DateColumn::name('lendingDate')->truncate()->searchable()->label('Ausgeliehen am'),
            //Column::name('org_id_2')->truncate()->searchable()->label('Rückgabe an'),
